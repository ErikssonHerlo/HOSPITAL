 ...
 */
@WebServlet(name = "BusquedaMedico", urlPatterns = {"/BusquedaMedico"})
public class BusquedaMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BusquedaMedico</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BusquedaMedico at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String horario = (String)request.getParameter("horario");
             AccesoAMedico acceso = new AccesoAMedico();
        ...
        RequestDispatcher despachar = request.getRequestDispatcher("BusquedaMedico.jsp");
