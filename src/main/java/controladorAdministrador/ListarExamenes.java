...
public class ListarExamenes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        AccesoAExamen acceso = new AccesoAExamen();
          request.setAttribute("Reporte", acceso.listarExamenes());
  
        RequestDispatcher despachar = request.getRequestDispatcher("ListarExamenes.jsp");
