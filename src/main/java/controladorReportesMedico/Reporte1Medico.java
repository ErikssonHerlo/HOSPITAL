 ...
 */
@WebServlet(name = "Reporte1Medico", urlPatterns = {"/Reporte1Medico"})
public class Reporte1Medico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String codigoUsuario = (String)request.getSession().getAttribute("codigoUsuario");
            ...
            request.setAttribute("ReporteHistorialMedico", accesoMedico.historialMedicoReporte1());
        ...
        RequestDispatcher despachar = request.getRequestDispatcher("Historial_Medico.jsp");
