...
<html>
    ...
    <body>
        ...
        <% if ((String) request.getSession().getAttribute("codigoUsuario") != null && (int) request.getSession().getAttribute("tipoUsuario") == 1) {%>
            ...
            <h1 class="align-content-lg-center">Los 5 Medicos con Menor Cantidad de Citas Medicas Agendadas</h1>
            <h3 class="align-content-lg-center">Intervalo de Tiempo:</h3>

            <FORM class="col-12 caja2" METHOD="GET" ACTION="Reporte3Admin">  
                <div class="row">
