...
<html>
    ...
    <body>
        ...
        <% if((String)request.getSession().getAttribute("codigoUsuario") != null && (int)request.getSession().getAttribute("tipoUsuario") == 1) {%>
            ...
            <% RequestDispatcher despachar = request.getRequestDispatcher("ListarMedicos");
...
<div class="container" style="padding-top: 80px" >
    ...
    <h1 class="align-content-lg-center">Listado de Medicos Registrados en el Hospital</h1>
            <c:choose>
                <c:when test="${Reporte.isEmpty()}">
                <div class="alert alert-danger">
                    No existe ningun Registro de Medicos en Nuestro Hospital
                </div>
            </c:when>
            <c:otherwise>
