...
<html>
    ...
    <div class="container" style="padding-top: 60px" >
        ...
        <!-- -------------------------HISTORIAL MEDICO DE CONSULTAS  ------------------>
            <h1 class="align-content-lg-center">Historial Medico del Paciente <%=request.getSession().getAttribute("nombreUsuario")%></h1>
            <c:choose>
                <c:when test="${HistorialMedico.isEmpty()}">
            ...
            <h1 class="align-content-lg-center">Historial del Laboratorio del Paciente <%=request.getSession().getAttribute("nombreUsuario")%></h1>
            <c:choose>
                <c:when test="${HistorialLaboratorio.isEmpty()}">
                <div class="alert alert-danger">
