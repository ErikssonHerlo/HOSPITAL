...
<html>
 ...
 <% if (request.getAttribute("Exitoso") == null) {%>
        <div class="container" style="padding-top: 50px" >
            ...
            <FORM class="col-12 caja2" METHOD="POST" ACTION="NuevoPacienteLogin">  
                <div class="row">
            ...
            <CENTER>
                   ...
                   <a href="Login.jsp" class="btn btn-primary">Regresar al Inicio de Sesión</a>
                </CENTER>
        </div>
        <% } else {%>
        <div class="container" style="padding-top: 70px" >
            ...
            <div class="col-12 caja2">
                <CENTER>
                    ...
                    <a href="NuevoPacienteLogin.jsp" class="btn btn-primary">Ingresar Datos de Nuevo</a>
