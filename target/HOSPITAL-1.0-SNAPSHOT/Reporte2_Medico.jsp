...
<html>
    ...
    <body>
        ...
        <% if ((String) request.getSession().getAttribute("codigoUsuario") != null && (int) request.getSession().getAttribute("tipoUsuario") == 4) {%>
            ...
            <h1 class="align-content-lg-center">Ultimas Citas Agendadas con el Medico <%=request.getSession().getAttribute("nombreUsuario")%></h1>
            <h3 class="align-content-lg-center">Intervalo de Tiempo:</h3>

            <FORM class="col-12 caja2" METHOD="GET" ACTION="Reporte2Medico">  
                <div class="row">
            ...
            <c:choose>
                <c:when test="${Reporte.isEmpty()}">
                    <div class="alert alert-danger">
                        El Medico No Tiene Ninguna Cita Agendada en Este Intervalo de Tiempo
                    </div>
                </c:when>
                <c:otherwise>
